...
@Component({
  selector: 'app-state-sync-node-dialog',
  imports: [CommonModule, FormsModule, TabComponent, ContextViewerComponent],
  templateUrl: './state-sync-node-dialog.component.html',
  styleUrls: ['./state-sync-node-dialog.component.scss'],
})
export class StateSyncNodeDialogComponent implements OnInit {
  ...
  public node: StateSyncNodeEntity;
