...
@Component({
  selector: 'app-step-start-node-dialog',
  imports: [CommonModule, FormsModule, TabComponent, ContextViewerComponent],
  templateUrl: './step-start-node-dialog.component.html',
  styleUrls: ['./step-start-node-dialog.component.scss'],
})
export class StepStartNodeDialogComponent implements OnInit {
  ...
  public node: StepStartNodeEntity;
