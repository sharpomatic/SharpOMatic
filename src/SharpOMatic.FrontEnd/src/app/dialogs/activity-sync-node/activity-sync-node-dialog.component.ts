...
@Component({
  selector: 'app-activity-sync-node-dialog',
  imports: [CommonModule, FormsModule, TabComponent, ContextViewerComponent],
  templateUrl: './activity-sync-node-dialog.component.html',
  styleUrls: ['./activity-sync-node-dialog.component.scss'],
})
export class ActivitySyncNodeDialogComponent implements OnInit {
  ...
  public node: ActivitySyncNodeEntity;
