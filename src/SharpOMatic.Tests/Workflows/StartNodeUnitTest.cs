...
public sealed class StartNodeUnitTest
{
    ...
    {
        var workflow = new WorkflowBuilder().AddStart().AddStart().Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart().Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateBoolInput("input.boolean", false)).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateBoolInput("", false)).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateBoolInput("input.boolean", true, true)).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateJsonInput("input.json", true, "[42, 3.14, false]")).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateExpressionInput("input.expr", true, "return 2 + 2;")).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateInputEntry("input.integer", true, ContextEntryType.Int, "not-int")).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateInputEntry("input.double", true, ContextEntryType.Double, "not-double")).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateInputEntry("input.json", true, ContextEntryType.JSON, "{ invalid")).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateInputEntry("input.expr", true, ContextEntryType.Expression, "missing")).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateInputEntry("input.asset", true, ContextEntryType.AssetRef, string.Empty)).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateInputEntry("input.assets", true, ContextEntryType.AssetRefList, string.Empty)).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateIntInput("input.list[0]", false)).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true, WorkflowBuilder.CreateStringInput("input.nullValue", false)).Build();
    ...
    {
        var workflow = new WorkflowBuilder().AddStart("start", true).Build();
