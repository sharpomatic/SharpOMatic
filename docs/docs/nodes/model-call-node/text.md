...
Immediately before the provider call, the resolved **Prompt** is stored as silent user text stream events unless **Disable User Event** is enabled on the **Stream** tab.
