...
If **Chat Output Path** is set, the chat transcript can still include native tool calls and tool results unless **Drop Tool Calls** is enabled on the **Details** tab.
